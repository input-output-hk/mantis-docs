...
The checkpointing nodes may be a new group structure (as a "federation of nodes" either from a fixed committee or the result of a recurring election process) or based on a randomized selection from miners.  
