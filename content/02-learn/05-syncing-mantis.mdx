...
To read more about the synchronization process in Ethereum, [see here](https://github.com/ethereum/devp2p/blob/master/caps/eth.md).
...
The only solution to this is to wait and let the client sync. The Mantis team is working on performance optimizations and UI improvements to better communicate this situation.
