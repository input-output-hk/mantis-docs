...
Universal Plug and Play (UPnP) is a feature that allows a Mantis node to participate in peer discovery, even when it is behind a router. Peer discovery is an essential precondition for ledger synchronization.
