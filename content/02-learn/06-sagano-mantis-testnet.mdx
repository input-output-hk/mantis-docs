...
Mantis is in the final stages of internal testing for a fully implemented 'Sagano' testnet, which will be available externally in the coming weeks. This testnet highlights Mantis' and IOG's commitment to push innovation within the ETC ecosystem.
...
Future testnet features the Mantis team is planning to integrate:
