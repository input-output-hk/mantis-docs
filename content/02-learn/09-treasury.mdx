...
This should promote greater developer engagement and independence and ultimately, will give the ecosystem sustainability it needs for *innovation, stability and growth*.
...
Why have a Treasury? In short, Blockchains are complex projects and they need substantial funding in order to become sustainable. On top of that, the recent security problems in the current Ethereum Classic chain has seen with the 51% attacks have shown the need for consistent innovation in order to guarantee the project a long

> Note: 51% attacks occur when a group of miners of more than 50% of the network's mining hash rate decide to collude in order to cause a network disruption.

While security can be increased through other means (including another proposal of ours, [ECIP 1097](https://ecips.ethereumclassic.org/ECIPs/ecip-1097)), it doesn't seem to be a good, long-term solution.
...
The Proto-Treasury will offer sustainable and consistent funding for underlying blockchain development and maintenance.
