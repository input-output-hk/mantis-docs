...
This lightweight explorer allows users to monitor activity on the testnet. The explorer shows detailed transaction activity as well as labelling which blocks are checkpointing blocks.
