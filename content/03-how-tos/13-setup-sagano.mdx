...
```  
At this point you have a contained Sagano API service and can utilize the local endpoint for your local dapp development enviorment.

Additional resources:

Sagano Faucet: Get testnet ETC to your testnet account.  
Sagano Explorer: Search and inspect blocks, transactions, addresses on Sagano testnet.  
Mantis Docs: Mantis client and wallet documentation.  
Select a repo  