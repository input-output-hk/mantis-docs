---
title: How to deploy smart contracts with Truffle
metaTitle: How to deploy smart contracts with Truffle
---

## Overview

Here we describe how to use the testing framework of the [truffle suite of products](https://www.trufflesuite.com/docs/truffle/testing/testing-your-contracts) to test smart contracts.
## Setting up a node
...
```   
Put in your own string for a passphrase. The result will look like:   
...
```
	...
	This will unlock the account for some time.	
