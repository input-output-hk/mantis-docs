...
# How to install Mantis on MacOS

This section outlines how to install the Mantis client on your MacOS machine.

## Requirements
These are the prerequisites you need for installing Mantis on MacOS:
* A Java Virtual Machine (JVM) with version 1.8.x.<br/>
    To check the JVM version use java -version.<br/>
    To install Java on MacOS, [follow these instructions](https://www.java.com/download/help/mac_install.html).
...
To install Mantis on MacOS, follow these steps:
1. ownload the client binary zip archive from the [Mantis releases page](https://github.com/input-output-hk/mantis/releases).
