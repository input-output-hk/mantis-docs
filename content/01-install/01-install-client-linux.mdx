---
title: Install Client on Linux
metaTitle: Install Client on Linux
---
> Author's note to reviewers: Please check the Linux installation steps. I do not have a Linux machine. Linux or Unix?
...
This section describes how to install the Mantis client on your Linux machine. Instructions to install the Mantis wallet are [here](/install/-install-wallet-linux).
