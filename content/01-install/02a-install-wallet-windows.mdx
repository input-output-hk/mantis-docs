...
1. Download the client binary from the Mantis Wallet page at [MantisClient.io](https://mantisclient.io/):
![Mantis Wallet page](../images/1-Download.png).

2. Choose and download the correct installer from the Wallet quick-start page:
