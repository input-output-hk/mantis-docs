...
---
>Author's note to reviewers: I understand that the Mantis wallet is a full-node wallet, so it does need disk space to sync. What about mining? Please clarify.
...
This section outlines how to install the Mantis wallet on your Windows machine. Instructions to install the Mantis client are [here](/install/-install-client-windows).
