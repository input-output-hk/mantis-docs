...
This section describes how to install the Mantis client on your Linux or Apple Machine. Instructions to install the Mantis wallet are [here](/install/-install-wallet-linux).
