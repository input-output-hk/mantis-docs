...
This section describes how to install the Mantis client on your Apple Mac machine. Instructions to install the Mantis wallet are [here](/install/-install-wallet-Mac).
